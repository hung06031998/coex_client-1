...
public class HistoryItemAdapterPoint extends RecyclerView.Adapter<HistoryItemAdapterPoint.viewHolder> {
    private List<ListExchangePoint> dataCoin;
    private Context mContext;

    public HistoryItemAdapterPoint(Context context) {
        this.mContext = context;
    }


    public void setData(List<ListExchangePoint> data) {
        this.dataCoin = data;
    ...
    public class viewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindView(ListExchangePoint item) {
            if (item.getCoin() > 0) {
            ...
            txtMoney.setText(decimalFormatter.format(item.getCoin()) + " point");
            try {
